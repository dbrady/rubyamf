...
begin
  ...
  RUBYAMF_VO = RUBYAMF_ROOT + '/services/service_vos/'
  ...
  #services to be set here otherwise exceptions get thrown. not sure why    
  RUBYAMF_SERVICES = RUBYAMF_ROOT + OPTIONS[:services_path].to_s
